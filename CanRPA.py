...
class Task(TaskBase):
   ...
   # def tarih(self):
    ...
    def sicil(self):
        ...
        self.selenium.click_element(locator="xpath://*[@id='menuForm:anaMenu1subMenu2subItem1']/span")
        time.sleep(2)
        iframe=self.selenium.get_webelement(locator="xpath://*[@id='pencereLinkIdYeni']")
        print("İFRAME:",iframe.get_attribute("innerHTML"))
        #/html/body/div/div/table/tbody/tr[2]/td/table/tbody/tr[2]/td[2]/div/form/table/tbody/tr[1]/td[3]/label/select

        self.selenium.click_element(locator="/html/body/div/div/table/tbody/tr[2]/td/table/tbody/tr[2]/td[2]/div/form/table/tbody/tr[1]/td[3]/label/select")
        ...
        if self.ayrac== "000":
            self.ünvan2=self.selenium.get_webelement(locator="xpath://*[@id='contentContainer']/div/table/tbody/tr[2]/td/table/tbody/tr[2]/td[2]/div/table[2]/tbody/tr[2]/td[1]/p")
